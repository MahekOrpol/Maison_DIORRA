    ...
    <section className='wrapper pt-6 md:pt-7 lg:pt-10 xl:pt-14'>
      ...
      <div className='flex flex-col gap-2 sm:gap-4 lg:flex-row lg:items-stretch lg:gap-6 xl:gap-8'>
        ...
        <div className='relative aspect-[766/980] w-full overflow-hidden rounded-md border lg:w-[60%]'>
          ...
          <div className='xs:top-[24%] absolute top-[23%] right-[17%] flex h-5.5 w-5.5 items-center justify-center rounded-full border border-white sm:h-7 sm:w-7 md:top-[25%] md:right-[18%] md:border-2 lg:top-[24%] lg:right-[17%] xl:top-[24%] xl:h-8 xl:w-8 2xl:right-[18%]'>
            <CustomTooltip />
          </div>
        </div>
