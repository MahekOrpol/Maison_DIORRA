      ...
      <div className='flex flex-col gap-2 sm:gap-4 lg:flex-row lg:items-stretch lg:gap-6 xl:gap-8'>
        ...
        <div className='relative aspect-[766/980] w-full overflow-hidden rounded-md border lg:w-[60%]'>
          ...
          <MarkerButton
            ...
            className='absolute right-[26%] bottom-[32%] lg:right-[22%] 2xl:right-[24%]'
          />
          ...
          <MarkerButton
            ...
            className='absolute top-[23%] right-[17%] md:top-[25%] md:right-[18%] lg:top-[24%] xl:top-[24%] 2xl:right-[18%]'
          />
        </div>
...
function MarkerButton({ onClick, tooltipContent, className }) {
  return (
    <TooltipProvider>
      ...
      >
        <Tooltip>
          <TooltipTrigger className='h-4 w-4 rounded-full bg-white sm:h-5 sm:w-5 xl:h-6 xl:w-6' />
