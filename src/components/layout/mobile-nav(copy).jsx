...
export default function MobileSidebarCopy({
  ...
  return (
    <Drawer direction='left' repositionInputs={false}>
      ...
      <DrawerContent className='flex flex-col border-none bg-white/90 p-0 backdrop-blur-lg data-[vaul-drawer-direction=left]:w-[85%]'>
...
function DiamondsSubmenu({ DiamondShapes }) {
  return (
    <div className='space-y-4'>
      <div>
        <h4 className='mt-2 mb-2 text-base font-medium underline'>
          Diamonds By Shape
        </h4>
          ...
          {[
            ...
            <li key={price}>
              <Link
                ...
                className='py-1 text-sm font-light hover:underline'
              >
                {price}
              </Link>
            </li>
