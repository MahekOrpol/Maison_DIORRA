    ...
    <>
      ...
      >
        ...
        <button
          ...
          className='hover:bg-primary/4 absolute top-1 right-1 xl:top-3 xl:right-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white shadow shadow-gray-400'
        >
          <Heart
            className={cn(
        ...
        <CardContent className='xs:px-2 w-full space-y-1 px-1 sm:space-y-2 xl:px-4 xl:pb-3'>
          ...
          <p className='xs:text-base block text-left text-sm font-light text-gray-900 sm:text-lg xl:font-normal 2xl:text-xl mb-2'>
            <button
              onClick={handleProductClick}
