    ...
    <>
      <div className='flex flex-col justify-between gap-[3%] min-[1000px]:flex-row 2xl:gap-[4%]'>
        ...
        <div className='order-2 mt-4 flex-1 min-[1000px]:order-1 min-[1000px]:mt-0'>
          <h2 className='mb-4 text-xl font-semibold xl:text-3xl'>
          ...
          <FormProvider {...methods}>
            ...
            >
              ...
              <div className='w-full space-y-4'>
                ...
                <Button
                  variant={'secondary'}
                  className='bg-secondary h-10 w-full border border-gray-400 py-2 text-lg font-light text-black lg:w-64 lg:bg-black lg:text-white'
                  type='submit'
                >
                  Save Address
                </Button>
      ...
      <div className='mt-10 flex flex-col items-center justify-center text-center md:mt-16'>
        ...
        <div className='mt-4 inline-flex gap-4'>
          <Link
            ...
            aria-label='PHONE'
            className='bg-primary text-primary-foreground flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 hover:scale-110 md:h-12 md:w-12'
          >
            <IoCall size={22} />
          </Link>
