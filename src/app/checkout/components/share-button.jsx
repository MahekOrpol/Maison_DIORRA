...
export default function ShareButton({ className, url, title, media }) {
    ...
    return (
        <div ref={shareRef} className={cn("relative inline-block", className)}>
            ...
            <div
                className={cn(
                    "absolute right-0 top-0 z-10 flex items-center gap-2 transition-all duration-300 w-[90vw]",
                    isOpen
            ...
            >
                <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[#3b5998] text-white transition hover:opacity-90 hover:scale-110"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[#55acee] text-white transition hover:opacity-90 hover:scale-110"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[#bd081c] text-white transition hover:opacity-90 hover:scale-110"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-[#25D366] text-white transition hover:opacity-90 hover:scale-110"
