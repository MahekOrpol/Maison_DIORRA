...
export default function NotFound() {
  return (
    <>
      <Header />
      <div className='flex min-h-[80vh] flex-col items-center justify-center bg-white p-6 pt-[85px] text-black min-[1023px]:pt-[118px]'>
        {/* Animated diamond */}
        ...
        <p className='mb-8 max-w-md text-center text-gray-600'>
          The page you're looking for doesn't exist or has been moved. Like a
          rare diamond, it's currently out of sight.
        </p>
